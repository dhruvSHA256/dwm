...
// static const char *fonts[]          = {"Source Code
// Pro:style=Regular:pixelsize=12:antialias=true:autohint=true","Symbols Nerd
// Font:style=2048-em"};
static const char *fonts[] = {
    "JetBrains Mono NL:style=Regular:size=9:antialias=true:autohint=true",
    "Symbols Nerd Font:style=2048-em", "JoyPixels:style=Regula"};
...
static const char *const autostart[] = {
    ...
    /// home/pixie/.config/picom/picom.conf", NULL,
    //"xsetroot -name ''",NULL  ,
    //"dwmblocks &",NULL  ,
    //"xsetroot -name ''",NULL ,
    //"dwmblocks &",NULL  ,
...
static Key keys[] = {
    ...
    //	{ MODKEY,                       XK_p,      spawn,          {.v =
    // dmenucmd } }, { MODKEY,                       XK_Return, spawn, {.v =
    // termcmd } },
